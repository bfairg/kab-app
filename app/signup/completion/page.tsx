    ...
    const run = async () => {
      ...
      for (let i = 1; i <= maxAttempts; i++) {
        ...
        try {
          ...
          // 409 = still waiting for mandate/confirmation
          if (res.status === 409) {
            await sleep(delayMs);
            continue;
          }
                ...
                <div className="p-6">
                  ...
                  {SHOW_DEBUG && debugJson && (
                    <div className="mt-5 text-left rounded-xl border border-white/10 bg-black/30 p-4">
                      <div className="text-xs text-white/60 mb-2">Debug response from /api/gocardless/complete</div>
